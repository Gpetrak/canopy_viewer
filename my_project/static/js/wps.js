...
function addRasterInput(input) {
      ...
      field.value = "";
      //window.open("http://localhost:8080/geoserver/wcs?crs=EPSG%3A4326&service=WCS&format=GeoTIFF&request=GetCoverage&height=550&width=1243&version=1.0.0&BBox=22.234599033751866%2C37.31601381793159%2C24.185826418485533%2C38.17909769624207&Coverage=geonode%3Al8_ms_11_01_14");
      document.getElementById("input").appendChild(field);
      (field.onblur = function() {
          input.reference = {
              mimeType: "image/tiff",
